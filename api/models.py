...
class Proyecto(models.Model):
    ...
    desague = models.BooleanField(blank=True, null=True)
    luz = models.BooleanField(blank=True, null=True)
    alumbrado_publico = models.BooleanField(blank=True, null=True)
    postes_luz = models.BooleanField(blank=True, null=True)
    veredas = models.BooleanField(blank=True, null=True)
